...
student_names=["test_group2_1" "test_group2_2"]
...
# driver model
params.acc_lat_max=0.78 # [g's] maximum lateral acceleration, used to compute target speeds based on track curvature
