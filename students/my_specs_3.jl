...
student_names=["test_group3_1" "test_group3_2"]
...
params.acc_brake_max=0.52 # [g's] maximum braking acceleration, used to decide when to apply the brakes during corner entry
