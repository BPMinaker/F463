...
student_names=["test_group5_1" "test_group5_2"]
student_numbers=["000000009" "000000010"]
...
# driver model
params.acc_lat_max=0.88 # [g's] maximum lateral acceleration, used to compute target speeds based on track curvature
params.acc_brake_max=0.22 # [g's] maximum braking acceleration, used to decide when to apply the brakes during corner entry
