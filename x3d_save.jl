function x3d_save(frag,trck,file_name,time)
...
println(file,"<x3d width='1920px' height='1080px'>")
println(file,"<Scene>")
...
println(file,"<material diffuseColor='1.0 0.0 0.0' emissiveColor='0.0 0.0 0.5'></material>")
println(file,"</appearance>")
println(file,trck)
println(file,"</shape>")
...
println(file,"<TimeSensor DEF='IDtimer' loop='true' cycleInterval='",time[3],"'></TimeSensor>")  ## At the loop timer for the animations
println(file,frag[1])  ## Insert the incoming x3d content

println(file,"<TimeSensor DEF='IDtimer' loop='true' cycleInterval='",time[3],"'></TimeSensor>")  ## At the loop timer for the animations
println(file,frag[2])  ## Insert the incoming x3d content

println(file,"<TimeSensor DEF='IDtimer' loop='true' cycleInterval='",time[3],"'></TimeSensor>")  ## At the loop timer for the animations
println(file,frag[3])  ## Insert the incoming x3d content
